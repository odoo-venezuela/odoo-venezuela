...
class wh_iva_config(osv.osv_memory):
    ...
    _columns = {
        ...
        'journal_purchase_vat': fields.char("Journal Wh Income Purchase", 64, help="Journal for purchase operations involving Withholding Income"),
        'journal_sale_vat': fields.char("Journal Wh Income Sale", 64, help="Journal for sale operations involving Withholding Income"),
    }
    _defaults = {
        'journal_purchase_vat': _("Journal Withholding VAT Income Purchase"),
        'journal_sale_vat': _("Journal Withholding VAT Income Sale"),
    }
