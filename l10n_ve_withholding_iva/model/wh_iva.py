...
class account_wh_iva_line_tax(osv.osv):
    ...
    _columns = {
        ...
        'wh_vat_line_id':fields.many2one('account.wh.iva.line', 'Withholding VAT Line', required=True, ondelete='cascade', help="Linea de retencion de IVA"),
        ...
        'name': fields.related('inv_tax_id', 'name', type='char', string='Tax Name', size=256, store=True, select=True, readonly=True, ondelete='set null', help="Name"),
