...
class account_wh_iva_line(osv.osv):
    ...
    _columns = {
        ...
        'date': fields.related('retention_id', 'date', type='date', relation='account.wh.iva', string='Date', store='True'),
        'date_ret': fields.related('retention_id', 'date_ret', type='date', relation='account.wh.iva', string='Date Withholding', store='True')
    }
