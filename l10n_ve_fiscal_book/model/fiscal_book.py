...
class fiscal_book_lines(orm.Model):
    ...
    _columns={
        ...
        'get_emission_date': fields.date(string='Emission Date',
            help='invoices -> get_date_document, wh iva lines -> date'),
        'get_accounting_date': fields.date(string='Accounting Date',
            help='invoices -> date_invoice , wh iva lines -> date_ret'),
        'get_imex_date': fields.date(string='Imex Date',
            help='Importation or Exportation date. (only applies to invoices - get_date_imported)'),
