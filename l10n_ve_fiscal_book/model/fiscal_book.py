...
class fiscal_book(orm.Model):
    ...
    _columns={
        ...
        'get_vat_general_i_base_sum': fields.function(_totalization,
                ...
                string="Importaciones Gravadas por Alícuota General (Base Imponible).",
                help="Importaciones Gravadas por Alícuota General (Base Imponible)."),
        'get_vat_general_i_tax_sum': fields.function(_totalization,
                type="float", method=True, store=True,
                digits_compute=dp.get_precision('Account'),
                string="Importaciones Gravadas por Alícuota General (Crédito Fiscal)",
                help="Importaciones Gravadas por Alícuota General (Crédito Fiscal)."),
        'get_vat_additional_i_base_sum': fields.function(_totalization,
                type="float", method=True, store=True,
                digits_compute=dp.get_precision('Account'),
                string="Importaciones Gravadas por Alícuota Gral. más Adicional (Base Imponible).",
                help="Importaciones Gravadas por Alícuota Gral. más Adicional (Base Imponible)."),
        'get_vat_additional_i_tax_sum': fields.function(_totalization,
                type="float", method=True, store=True,
                digits_compute=dp.get_precision('Account'),
                string="Importaciones Gravadas por Alícuota Gral. más Adicional (Crédito Fiscal).",
                help="Importaciones Gravadas por Alícuota Gral. más Adicional (Crédito Fiscal)."),
        'get_vat_reduced_i_base_sum': fields.function(_totalization,
                type="float", method=True, store=True,
                digits_compute=dp.get_precision('Account'),
                string="Importaciones Gravadas por Alícuota Reducida (Base Imponible).",
                help="Importaciones Gravadas por Alícuota Reducida (Base Imponible)."),
        'get_vat_reduced_i_tax_sum': fields.function(_totalization,
                type="float", method=True, store=True,
                digits_compute=dp.get_precision('Account'),
                string="Importaciones Gravadas por Alícuota Reducida (Crédito Fiscal).",
                help="Importaciones Gravadas por Alícuota Reducida (Crédito Fiscal)."),
        'get_vat_general_n_base_sum': fields.function(_totalization,
                type="float", method=True, store=True,
                digits_compute=dp.get_precision('Account'),
                string="Internas Gravadas sólo por Alícuota General (Base Imponible).",
                help="Internas Gravadas sólo por Alícuota General (Base Imponible)."),
        'get_vat_general_n_tax_sum': fields.function(_totalization,
                type="float", method=True, store=True,
                digits_compute=dp.get_precision('Account'),
                string="Internas Gravadas sólo por Alícuota General (Crédito Fiscal).",
                help="Internas Gravadas sólo por Alícuota General (Crédito Fiscal)."),
        'get_vat_additional_n_base_sum': fields.function(_totalization,
                type="float", method=True, store=True,
                digits_compute=dp.get_precision('Account'),
                string="Internas Gravadas sólo por Alícuota General más Adicional (Base Imponible).",
                help="Internas Gravadas sólo por Alícuota General más Adicional (Base Imponible)."),
        'get_vat_additional_n_tax_sum': fields.function(_totalization,
                type="float", method=True, store=True,
                digits_compute=dp.get_precision('Account'),
                string="Internas Gravadas sólo por Alícuota General más Adicional (Crédito Fiscal).",
                help="Internas Gravadas sólo por Alícuota General más Adicional (Crédito Fiscal)."),
    ...
    def update_book_lines(self, cr, uid, fb_id, context=None):
        ...
        for inv_brw in self.browse(cr, uid, fb_id, context=context).invoice_ids:
            ...
            values = {
                ...
                'get_nro_import_expe': hasattr(inv_brw, 'num_import_expe') and inv_brw.num_import_expe and inv_brw.nro_inport_expe or False,
...
class fiscal_book_lines(orm.Model):
    ...
    _columns={
        ...
        'get_nro_import_form': fields.char(string='Import form number',
                size=192, help=""),
        'get_nro_import_expe': fields.char(string='Import file number',
                sizr=192, help=""),
