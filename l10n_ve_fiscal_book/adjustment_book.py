...
class adjustment_book(osv.osv):
    ...
    _columns={
        ...
        'amount_total':fields.function(_get_amount_total,multi='all',method=True, digits_compute=dp.get_precision('Account'),string='Amount Total VAT Withholding',readonly=True,help="Amount Total for adjustment book of invoice"),
        ...
        'amount_with_vat_total':fields.function(_get_amount_total,multi='all',method=True, digits_compute=dp.get_precision('Account'),string='Amount VAT Withholding Total',readonly=True,help="Amount Total VAT Withholding for adjustment book"),
...
class adjustment_book_line(osv.osv):
    ...
    _columns={
        ...
        'percent_with_vat_n': fields.float('% VAT Withholding', digits_compute=dp.get_precision('Account'),required=True,help="Percent(%) VAT for national operations"),
        'amount_with_vat_n': fields.float('Amount VAT Withholding', digits_compute=dp.get_precision('Account'),required=True,help="Percent(%) VAT for national operations"),
        ...
        'percent_with_vat_i': fields.float('% VAT Withholding', digits_compute=dp.get_precision('Account'),required=True,help="Percent(%) VAT for international operations"),
        'amount_with_vat_i': fields.float('Amount VAT Withholding', digits_compute=dp.get_precision('Account'),required=True,help="Amount withholding VAT for international operations"),
        'amount_with_vat': fields.float('Amount VAT Withholding Total', digits_compute=dp.get_precision('Account'),required=True,help="Amount withheld VAT total"),
        'voucher': fields.char('Voucher VAT Withholding', size=256,required=True,help="Voucher VAT Withholding"),
