...
class account_invoice(osv.osv):
    ...
    def _get_inv_islr_from_line(self, cr, uid, ids, context={}):
        move = {}
    ...
    def _get_inv_islr_from_reconcile(self, cr, uid, ids, context={}):
        move = {}
    ...
    _columns = {
        'ret_islr': fields.function(_retenida_islr, method=True, string='Retention ISLR', type='boolean',
            store={
                'account.invoice': (lambda self, cr, uid, ids, c={}: ids, None, 50),
                'account.move.line': (_get_inv_islr_from_line, None, 50),
                'account.move.reconcile': (_get_inv_islr_from_reconcile, None, 50),
