...
class Atrasado(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(Atrasado, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.account.pagos_ve', 'res.partner',
        'addons/l10n_ve_pagos_atrs/report/pagos_atr.rml', parser=Atrasado)
